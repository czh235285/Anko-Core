    ...
    class Builder(private var text: CharSequence?) {
        ...
        private fun setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(ImageSpan(MyAPP.instance, bitmap), start, end, flag)
                    bitmap = null
                    imageIsBitmap = false
                    ...
                    mBuilder.setSpan(ImageSpan(MyAPP.instance, uri), start, end, flag)
                    uri = null
                    imageIsUri = false
                } else {
                    val d = ContextCompat.getDrawable(MyAPP.instance, resourceId)
