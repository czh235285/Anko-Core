...
import c.core.utils.span.VerticalImageSpan

/**
 * <pre> * author: Blankj * blog : http://blankj.com * time : 16/12/13 * desc :
 * SpannableString相关工具类 * </pre>
 */
class SpannableStringUtils {
    ...
    class Builder(private var text: CharSequence?) {
        ...
        /**
         * 设置标识 * * @param flag  *  * [Spanned.SPAN_INCLUSIVE_EXCLUSIVE] *
         *  * [Spanned.SPAN_INCLUSIVE_INCLUSIVE] *
         *  * [Spanned.SPAN_EXCLUSIVE_EXCLUSIVE] *
         *  * [Spanned.SPAN_EXCLUSIVE_INCLUSIVE] *  * @return [Builder]
         */
        ...
        /**
         * 设置前景色 * * @param color 前景色 * @return [Builder]
         */
        ...
        /**
         * 设置背景色 * * @param color 背景色 * @return [Builder]
         */
        ...
        /**
         * 设置引用线的颜色 * * @param color 引用线的颜色 * @return [Builder]
         */
        ...
        /**
         * 设置缩进 * * @param first 首行缩进 * @param rest 剩余行缩进 * @return [Builder]
         */
        ...
        /**
         * 设置列表标记 * * @param gapWidth 列表标记和文字间距离 * @param color 列表标记的颜色 * @return [Builder]
         */
        ...
        /**
         * 设置字体比例 * * @param proportion 比例 * @return [Builder]
         */
        ...
        /**
         * 设置字体横向比例 * * @param proportion 比例 * @return [Builder]
         */
        ...
        /**
         * 设置字体 * * @param fontFamily 字体 *  *  * monospace *  * serif *
         *  * sans-serif *  * @return [Builder]
         */
        ...
        /**
         * 设置对齐 *  *  * [Alignment.ALIGN_NORMAL]正常 *
         *  * [Alignment.ALIGN_OPPOSITE]相反 *
         *  * [Alignment.ALIGN_CENTER]居中 *  * * @return [Builder]
         */
        ...
        /**
         * 设置图片 * * @param bitmap 图片位图 * @return [Builder]
         */
        ...
        /**
         * 设置图片 * * @param drawable 图片资源 * @return [Builder]
         */
        ...
        /**
         * 设置图片 * * @param uri 图片uri * @return [Builder]
         */
        ...
        /**
         * 设置图片 * * @param resourceId 图片资源id * @return [Builder]
         */
         ...
         * 设置点击事件 *
         *
         *需添加view.setMovementMethod(LinkMovementMethod.getInstance()) * @param
         * clickSpan
         * 点击事件 * @return [Builder]
         */
         ...
         *  * [Blur.NORMAL] *  * [Blur.SOLID] *
         *  * [Blur.OUTER] *  * [Blur.INNER] *  * @return
         * [Builder]
         */
        ...
        /**
         * 追加样式字符串 * * @param text 样式字符串文本 * @return [Builder]
         */
        ...
        private fun setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(ImageSpan(appCtx, bitmap!!), start, end, flag)
                    bitmap = null
                    imageIsBitmap = false
                } else if (imageIsDrawable) {
                    mBuilder.setSpan(VerticalImageSpan(drawable!!), start, end, flag)
                    drawable = null
                    imageIsDrawable = false
                } else if (imageIsUri) {
                    mBuilder.setSpan(ImageSpan(appCtx, uri!!), start, end, flag)
                    uri = null
                    imageIsUri = false
                } else {
                    val d = ContextCompat.getDrawable(appCtx, resourceId)
                    d!!.setBounds(0, 0, d.intrinsicWidth, d.intrinsicHeight)
                    mBuilder.setSpan(ImageSpan(d), start, end, flag)
                    resourceId = 0
